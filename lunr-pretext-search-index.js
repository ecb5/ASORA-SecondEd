...
},
{
  ...
  "number": "10.3.1",
  "title": "Sketch of Proof.",
  "body": " Sketch of Proof  There are two statements to prove:  That is continuous on the closed interval ,  that is differentiable on the open interval and that .  We will prove differentiablity on first. From that continuity on follows immediately (why?). Continuity at the endpoints will be addressed separately.  Let . To find we apply . Thus         We need to show that the limit in equation is . Since was assumed to be continuous on it is also continuous on the closed interval with endpoints and . We know from the Extreme Value Theorem that there are points , and , in the same interval such that and are the global minimum and maximum of on the closed interval with endpoints and , respectively.  Thus if we have or .  If , we have , and so  In either case we have   Applying the Squeeze Theorem   should do the trick.       To show that is continuous at the endpoints and , we will appeal to .  Consider any sequence contained in and converging to . We want to show that   To get continuity at , consider any sequence in converging to . We want to show that   It will be useful to recognize that on the function will have both a maximum and a minimum value (why?).        "
},
{
  "id": "SECTIONFTC-23",
  "level": "2",
