...
},
{
  ...
  "number": "12.4.8",
  "title": "",
  "body": " countable sets deleting a countable subset   Suppose is an uncountable set and is countably infinite.     Prove that and are both uncountable sets.      Prove that and have the same cardinality.    Let . Since is an infinite set, then by the previous problem it contains a countably infinite set . Likewise since is infinite it also contains an infinite set . Again, since is a countably infinite set then it contains a countably infinite set , etc. For , let be a one to one correspondence and define by .  Show that is one to one and onto.    "
},
{
