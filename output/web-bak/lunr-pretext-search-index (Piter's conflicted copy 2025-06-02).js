...
},
{
  ...
  "number": "3.1.4",
  "title": "",
  "body": "   Isaac Newton  Newton, Isaac portrait of   Portrait of Isaac Newton   "
},
{
...
{
  "id": "NewtonsApproach-52",
  "level": "2",
  "url": "CalcIn17th18thCentury-NewtLeibStart.html#NewtonsApproach-52",
  "type": "Problem",
  "number": "3.1.15",
  "title": "",
...
},
{
  ...
  "number": "6.2.3",
  "title": "",
  "body": " Triangle Inequalities Triangle Inequality   Prove Lemma .   For the Reverse Triangle Inequality, consider .    Show .   You want to show that and that .   "
},
{
...
},
{
  ...
  "number": "6.2.8",
  "title": "",
  "body": " sequences convergence of convergent sequences are bounded   Prove Lemma .    We know that there exists such that if , then . Let max , where represents the smallest integer greater than or equal to . Also, notice that this is not a convergence proof so it is not safe to think of as a large number.   Comment  Actually, this is a dangerous habit to fall into even in convergence proofs.    "
},
{
...
},
{
  ...
  "number": "6.2.10",
  "title": "",
  "body": "  If and , then .   Comment  This is a corollary to Theorem .    "
},
{
...
},
{
  ...
  "number": "6.2.13",
  "title": "",
  "body": "   sequences termwise quotient of Prove Theorem .   SCRAPWORK   To prove this we ll look first at special case. We ll prove that . The general case will follow from this and Theorem . Consider . We are faced with the same dilemma as before; we need to get bounded above. This means we need to get bounded away from zero (at least for large enough ).  This can be done as follows. Since , then . Thus, by the definition of , there exists such that if , then . Thus when , and so . This says that for , . We should be able to make this smaller than a given , provided we make large enough.   "
},
{
...
},
{
  ...
  "body": " Continuity at a Point    continuity definition of  continuity We say that a function is continuous at provided that for any , there exists a such that if then .   "
},
{
...
},
{
  ...
  "number": "10.1.2",
  "title": "Limit.",
  "body": " Limit  limit   We say provided that for each , there exists such that if then .   "
},
{
...
},
{
  ...
  "number": "10.1.10",
  "title": "",
  "body": "   Squeeze Theorem for functions Prove the Squeeze Theorem for functions .    Use Theorem , the Squeeze Theorem for sequences from Chapter .   "
},
{
...
},
{
  ...
  "number": "10.1.13",
  "title": "Near.",
  "body": " Near   We say that a function has a property for  near  , if there exists a such that has that property for all with    "
},
{
  ...
  "number": "10.1.14",
  "title": "",
  "body": "  Prove that the following is also a consequence of . Suppose .    If for near , then .    If for near , then .   "
},
{
...
},
{
  ...
  "body": " The Derivative, An Alternative Definition   Given a function defined on an interval , and a point , the derivative of is given by .   "
},
{
  "id": "thm_DiffImpCont",
  "level": "2",
...
},
{
  ...
  "number": "10.2.1",
  "title": "Sketch of Proof.",
  "body": " Sketch of Proof  There are two cases:   Case 1:   is a maximum, and    Case 2:   is a minimum.     Suppose is a maximum so that for all . Since is differentiable at , then we have   To show , we need to show that These facts follow directly from parts (a) and (b) of and the case where is a minimum can be handled by looking at ..          "
},
{
...
},
{
  ...
  "number": "10.2.15",
  "title": "",
  "body": "    differentiation  implies is decreasing nearby  Suppose that is differentiable on some interval , and is continuous on . If for some then there is an interval, , containing such that for every in where , .   "
},
{
...
},
{
  ...
  "body": " The Fundamental Theorem of Calculus  If you look back at the derivation of the Integral Form of the Remainder for Taylor Series ( ) you ll see that the Fundamental Theorem of Calculus was our anchor step. We assumed you were familiar with it from your Calculus course. In fact the Fundamental Theorem Of Calculus was known in various forms before Newton and Leibniz invented Calculus. They both provided derivations of it via the use of the infinitely small, but neither of them dubbed this The Fundamental Theorem. Both considered it very natural to apply the problem of antidifferentiation to that of finding areas. Consider Leibniz derivation from his 1693 paper titled    Supplementum geometriae dimensoriae, seu generalissima omnium tetragonismorum effectio per motum: similiterque multiplex constructio lineae ex data tangentium conditione .   which translates into    More on geometric measurement, or most generally of all practicing of quadrilateralization through motion: likewise many ways to construct a curve from a given condition on its tangents.    In fact Leibniz invented the differential and integral notation that we still use today because it is so well designed. Suppose that , then . Since these are differences, then integrating them just adds these differences together. Thus we have     (We are utilizing definite integral notation which was later addition by Fourier.) Anyway, Leibinz already knew that a finite sum of finite differences collapsed into the difference of the extremes as below.     Leibniz surmised that it would work for infinite sums of infinitesimals as well. This gives     For Leibniz, this idea so natural, you can see why he called his paper a supplementum. Leibniz included a picture with both and sharing an axis, but we will provide a more modern rendition with the graphs of and separated.      In the above graphs, the area of the infinitely thin rectangle on the left is given by and is numerically equal to the infinitely small length . Adding the areas on the left gives the area under the curve and the sum of the lengths on the right gives the length .  Of course, such a proof relying on infinitesimals would not pass 19 century (or modern day) rigor. Also, there is a question which surfaced as to if a given continuous function would always have an antiderivative. We have the tools to provide a rigorous proof of the Fundamental Theorem of Calculus with a proviso: we need to rigorously define what an integral is, which is more delicate than one might anticipate. We ll do this in the next section, but for now, let s utilize our knowledge of integration from Calculus and what we have proven in the last section to provide a more careful statement and proof of the Fundamental Theorem of Calculus. This formulation and proof is essentially Cauchy s in his Résumé des leçons donnés à l école royale polytechnique sur le calcul infinitesimal (1823).   The Fundamental Theorem of Calculus (Cauchy)  Suppose is continuous on and define   for . Then is continuous on , differentiable on and      Before we get into the proof of this, notice that it doesn t look like Leibniz version. Leibniz version follows from this as indicated in the problem below. As before, is continuous on .    Suppose is continuous on and on . Prove that for any , In particular,     You have two antiderivatives of . By part (c) of , these must differ by a constant. What must this constant be?    Let s now look at the idea behind proof of Cauchy s version of the Fundamental Theorem of Calculus. Some of these ideas should look familiar.   Outline of Proof  Let . First, we want to show that   . With this in mind, let be the minimum and be the maximum of on the closed interval with endpoints and . By the EVT , takes on its maximum and minimum at some points inside the interval, say and for some between and .  If we have     Dividing by we get   If , we have , and so  Which still leads us to   Applying the squeeze theorem as and continuity of at should do the trick.   This takes care of differentiability (and continuity) on .  To get continuity at and , we will appeal to Theorem 8.2.1 relating continuity and sequences. With that in mind, consider any sequence contained in converging to we want to show that   To get continuity at , consider any sequence in converging to . We want to show that   We can use an argument similar to what we did before, but in this case, since we are not dividing, we can just consider the minimum and maximum of on so that .   Turn the above ideas into a proof of .   As we said earlier, how do we know that a continuous function on a closed interval has an antiderivative? Equivalently, how do we know that actually exists?  "
},
{
  "id": "FTCCauchy",
  "level": "2",
...
},
{
  "id": "SECTIONFTC-18",
  "level": "2",
  "url": "SECTIONFTC.html#SECTIONFTC-18",
  "type": "Problem",
  "number": "10.3.2",
  "title": "",
  "body": "  Suppose is continuous on and on . Prove that for any , In particular,     You have two antiderivatives of . By part (c) of , these must differ by a constant. What must this constant be?   "
},
{
  "id": "SECTIONFTC-20",
  "level": "2",
  ...
  "body": " Outline of Proof  Let . First, we want to show that   . With this in mind, let be the minimum and be the maximum of on the closed interval with endpoints and . By the EVT , takes on its maximum and minimum at some points inside the interval, say and for some between and .  If we have     Dividing by we get   If , we have , and so  Which still leads us to   Applying the squeeze theorem as and continuity of at should do the trick.  "
},
{
  "id": "SECTIONFTC-25",
  "level": "2",
  ...
  "number": "10.3.3",
  "title": "",
  "body": " Turn the above ideas into a proof of .  "
},
{
  ...
  "body": " Defining the Integral  The seeds of what we call integration were planted long ago. In a letter to Eratosthenes (circa 250 BC), Archimedes described a mechanical method for finding areas and volumes. His method consisted of mentally dividing objects into infinitely thin slices and balancing these slices on a balance beam. Archimedes noted that this was not rigorous (presumably because it employed infinitely small objects).    ... I thought it might be appropriate to write down for you a special method, by means of which you will be able to recognize certain mathematical questions with the aid of mechanics. I am convinced that this is no less useful than finding the proofs of these same theorems.    Some things, which first became clear to me by the mechanical method, were afterwards proved geometrically, because their investigation by that method does not furnish an actual demonstration. It is easier to supply the proof when we have previously acquired, by the method, some knowledge of the questions than it is to find it without any previous knowledge. ...    Closer to our time mathematicians such as Kepler , Galileo , Cavalieri , Torricelli , Roberval , and others explored the idea computing areas and volumes by summing infinitesimals before it was developed by Newton and Leibniz into the modern approach. The Fundamental Theorem of Calculus was known by such mathematicians such as Fermat , Gregory , and Barrow before the invention of Calculus.  Which raises the question: What made mathematicians decide to take an old and seemingly natural idea and make it rigorous?  Part of the answer was implied from our study of Fourier series. A major research question in the 19th century was how random could a function defined on an interval be and still be represented by a Fourier series? Since the coefficients are computed via integration, a related question was how random could a function be and still be integrated? We will not answer these questions fully, but we will give a rigorous definition of integrability and use it to show that a continuous function on a closed interval is integrable. This will close the gap in our proof of the Fundamental Theorem of Calculus and show that a continuous function on an interval has an antiderivative. We have a warning that the details in this rigorous approach can get a bit overwhelming at times, but keep in mind the idea of trying to compute an area under a curve without resorting to infinitesimals underlies these ideas.  One of the first mathematicians to provide a rigorous definition of a definite integral was Augustin Cauchy in 1823. The basis of his approach was to approximate the integral with a finite sum, an idea that was used by a number of mathematicians in the 17th and 18th century to approximate an integral whose antiderivative was not readily computable. Specifically, if one wanted to approximate , one would start with a partition of the interval into a finite number of subintervals. Basically, the partition is a finite sequence of numbers . Cauchy then formed the sum   Geometrically, if , we are approximating the area under the curve with the area of a finite sum of boxes whose bases are the subintervals and whose heights are obtained by evaluating at the left endpoint . Here is a picture with .     Notice that the subintervals need not be the same length. We define to be the length of the largest subinterval or, . Cauchy said that a function defined on was integrable if there was a number such that for all , there is a such that   for any partition with , In this case we write   Cauchy was then able to show that any continuous function is Cauchy integrable and was able to prove the Fundamental Theorem of Calculus as we indicated in the last section.  In 1854, Bernhard Riemann presented a generalization of Cauchy s idea for a definite integral to the faculty at the University of Göttingen which was later published in 1868. His idea was similar to Cauchy s, except that instead of restricting the heights of the boxes to the left endpoints of the subintervals, he allowed the height of th box to be where is any point in the subinterval . Any Riemann integrable function is automatically Cauchy integrable and in this case the integrals are the same. Furthermore, Riemann was able to provide necessary and sufficient conditions for when a function was Riemann integrable. We won t go into that as it does not serve our purposes here.  You can t help but notice the similarity between this definition and the definition of a limit. Furthermore, just as with the definition of a limit, it does not tell how to compute the integral, only how to check if your guess is correct. This was not an issue in the 19th century as people already knew how to compute integrals. This was about integrability. Cauchy and Riemann developed ideas to deal with the issue of proving integrability without actually determining the value of the integral. Instead of doing that, we will use a different (yet equivalent) definition of the Riemann integral developed by Jean Gaston Darboux in 1875. The advantage of this is that it tells exactly what the integral is and it utilizes tools we ve already developed. There are discontinuous functions which are Darboux (and Riemann) integrable, but for our purposes, we will restrict ourselves to continuous functions. As before, we will start with a partition of the interval where . Let and denote the minimum and maximum of on , respectively. Define the lower (Darboux) sum by and upper (Darboux) sum by .  Notice that if we had a value for , then it should be clear that It should also be clear, geometrically, that as the number of intervals gets larger, then these bounds should get closer to the actual integral (if it exists). With this in mind, a partition is called a refinement of if as a set of points . Notice that every subinterval in the partition is contained inside some subinterval of the partition .    Using the observation above, show that if is a refinement of , then     First, show that this is true if is obtained by adding one point to .      Let and be any two partitions of . Show that     Consider that is a refinement of both and , and use the previous result.    With all this in mind, notice that the set of lower sums over all partitions of is a non-empty set of real numbers which is bounded above. As such it has a least upper bound. Define the lower (Darboux) integral by   Similarly, the set of all upper sums is a non-empty set of real numbers which is bounded below. Define the upper (Darboux) integral as the greatest lower bound of this set       Show that     Let be a fixed partition of . By , is an upper bound for the set of all lower sums. This says   However, is an arbitrary partition of .]     Darboux Integrability   A function is said to be (Darboux) integrable provided   In this case we define the (Darboux) integral by       As we mentioned before, Darboux s definition of the integral is equivalent to the Riemann integral but has the advantage that we ve already defined and established the existence of the supremum and infimum of a set. It turns out that using Riemann s formulation is easier to prove the typical theorems associated with definite integrals, but for our purposes in showing that a continuous function is integrable, the Darboux integral will work well.  We mentioned that we would restrict ourselves to continuous functions with the idea of proving that any continuous function is integrable and this was mainly done to ensure that on each subinterval, the function in question had a minimum and a maximum . This definition can be tweaked a bit to extend to bounded functions by looking at the infimum and supremum of on each subinterval. We won t do this, but before we set about our task, we should give an example of a function which is not integrable.  It turns out that the evolution of our modern definition of a function parallels the path of a modern definition of the definite integral. Issues of integrability were not prevalent in 18th century because mathematicians ideas of what constituted a function did not need it. For example, here is the definition of a function from Euler s  Introductio in analysin infinitorum  (1748).    A function of a variable quantity is an analytic expression composed in any way whatsoever of the variable quantity and numbers or constant quantities.    This is what you were accustomed to in Calculus. Fourier series ushered in a need for the more general definition of a function. Here is Fourier s definition from his  Théorie analytique de la Chaleur  (1822).    In general, the function~} represents a succession of values or ordinates each of which is arbitrary. An infinity of values being given of the abscissa , there are an equal number of ordinates . All have actual numerical values, either positive or negative or nul. We do not suppose these ordinates to be subject to a common law; they succeed each other in any manner whatever, and each of them is given as it were a single quantity.    This is closer to our modern approach that for each in the domain, there is a unique assigned to it. Based on Fourier s definition of a function, Lejeune Dirichlet provided an example of a function which is not integrable (1837).   Let       Show that so that is not integrable on .   Back to our task at hand, which is to show that a continuous function is integrable. With that in mind, we have the following theorem.   If is continuous on , then so is integrable.    Sketch of Alleged Proof  We already know that   To show that these are equal, we will show that for any ,   Since is arbitrary, this will say that or   To see this, since is continuous at each point in , choose a such that if , then . If we choose a partition such that , then on each subinterval , .  Thus    QED?    We say alleged proof because there is a subtle problem. Since is continuous on then it is continuous at each point . This says that for each , there is a , such that if then . If you look at our sketch of the proof, we need a single which works uniformly for all such . This leads to the following definition.   Uniform Continuity   Suppose . We say that is uniformly continuous on provided that for all , there is a such that for all with .    It is clear why this is called uniform continuity, since the must work uniformly for all , whereas in regular continuity, the may depend on the value of . It is also clear that any function which is uniformly continuous on a set is continuous on . The converse is not always true.   Consider on . Show that for any , whenever . Explain why this says that is not uniformly continuous on .   Fortunately for us, we have the following lemma.   If is continuous on the closed, bounded interval , then is uniformly continuous on .    Outline of Proof  We will do a proof by contradiction. Suppose is not uniformly continuous on . Then there is an such that for any , there are with , but . If we let , then we can create two sequences with , but By the Bolzano-Weierstrass Theorem, there is a and a subsequence with . Given how was constructed, . Since is continuous at , you should be able to get a contradiction out of this.    Turn the above outline into a proof of .    Prove    As you can see, making the idea of an integral rigorous was a delicate matter. Perhaps this is why it took so long to develop historically.  "
},
{
  "id": "SECTIONDefiningIntegral-16",
  "level": "2",
  "url": "SECTIONDefiningIntegral.html#SECTIONDefiningIntegral-16",
  "type": "Problem",
  "number": "10.4.1",
  "title": "",
  "body": "  Using the observation above, show that if is a refinement of , then     First, show that this is true if is obtained by adding one point to .   "
},
{
...
{
  "id": "SECTIONDefiningIntegral-21",
  "level": "2",
  "url": "SECTIONDefiningIntegral.html#SECTIONDefiningIntegral-21",
  "type": "Problem",
  "number": "10.4.3",
  "title": "",
...
{
  "id": "DEFINITIONDarbouxIntegrable",
  "level": "2",
  "url": "SECTIONDefiningIntegral.html#DEFINITIONDarbouxIntegrable",
  "type": "Definition",
  "number": "10.4.4",
  "title": "Darboux Integrability.",
  "body": " Darboux Integrability   A function is said to be (Darboux) integrable provided   In this case we define the (Darboux) integral by    "
},
{
  "id": "SECTIONDefiningIntegral-31",
  "level": "2",
  "url": "SECTIONDefiningIntegral.html#SECTIONDefiningIntegral-31",
  "type": "Problem",
  "number": "10.4.5",
  "title": "",
  "body": " Let       Show that so that is not integrable on .  "
},
{
  "id": "ContImpInt",
  "level": "2",
  "url": "SECTIONDefiningIntegral.html#ContImpInt",
  "type": "Theorem",
  "number": "10.4.6",
  "title": "",
...
{
  "id": "SECTIONDefiningIntegral-34",
  "level": "2",
  "url": "SECTIONDefiningIntegral.html#SECTIONDefiningIntegral-34",
  "type": "Proof",
  "number": "10.4.1",
  "title": "Sketch of Alleged Proof.",
  "body": " Sketch of Alleged Proof  We already know that   To show that these are equal, we will show that for any ,   Since is arbitrary, this will say that or   To see this, since is continuous at each point in , choose a such that if , then . If we choose a partition such that , then on each subinterval , .  Thus    QED?   "
},
{
  ...
  "body": " Uniform Continuity   Suppose . We say that is uniformly continuous on provided that for all , there is a such that for all with .   "
},
{
  "id": "SECTIONDefiningIntegral-38",
  "level": "2",
  "url": "SECTIONDefiningIntegral.html#SECTIONDefiningIntegral-38",
  "type": "Problem",
  "number": "10.4.8",
  "title": "",
...
{
  "id": "ContClosBddImpUnifCont",
  "level": "2",
  "url": "SECTIONDefiningIntegral.html#ContClosBddImpUnifCont",
  "type": "Lemma",
  "number": "10.4.9",
  "title": "",
...
{
  "id": "SECTIONDefiningIntegral-41",
  "level": "2",
  "url": "SECTIONDefiningIntegral.html#SECTIONDefiningIntegral-41",
  "type": "Proof",
  "number": "10.4.2",
  "title": "Outline of Proof.",
  "body": " Outline of Proof  We will do a proof by contradiction. Suppose is not uniformly continuous on . Then there is an such that for any , there are with , but . If we let , then we can create two sequences with , but By the Bolzano-Weierstrass Theorem, there is a and a subsequence with . Given how was constructed, . Since is continuous at , you should be able to get a contradiction out of this.  "
},
{
  "id": "SECTIONDefiningIntegral-42",
  "level": "2",
  "url": "SECTIONDefiningIntegral.html#SECTIONDefiningIntegral-42",
  "type": "Problem",
  "number": "10.4.10",
  "title": "",
...
{
  "id": "SECTIONDefiningIntegral-43",
  "level": "2",
  "url": "SECTIONDefiningIntegral.html#SECTIONDefiningIntegral-43",
  "type": "Problem",
  "number": "10.4.11",
  "title": "",
  "body": " Prove   "
...
},
{
  ...
  "body": " Absolute Convergence  Absolute Convergence    convergence of a series absolute Given a series , the series is called the absolute series of and if converges then we say that  converges absolutely.    "
},
{
...
},
{
  ...
  "number": "12.1.3",
  "title": "Open Sets.",
  "body": " Open Sets   A set of real numbers is open if its complement is closed.   "
},
{
  ...
  "number": "12.1.4",
  "title": "",
  "body": "  Show that a set is open if and only if for all there is an such that     Look back at the proof that showed that a closed interval is actually closed.   "
},
{
  ...
  "number": "12.1.5",
  "title": "",
  "body": " Open intervals are not the only open sets. Convince yourself that each of the above sets that the following are also open sets.         where each is an open set.    "
},
{
...
},
{
  ...
  "number": "12.1.7",
  "title": "",
  "body": "  Let , we define the image of by   For any , we define the preimage of by    "
},
{
  ...
  "number": "12.1.8",
  "title": "",
  "body": " Show that is continuous at if and only if for all open sets containing , there is an open set containing with .  "
},
{
...
{
  "id": "SECTIONLebesgMeas-9",
  "level": "2",
  "url": "SECTIONLebesgMeas.html#SECTIONLebesgMeas-9",
  "type": "Problem",
  "number": "12.3.4",
  "title": "",
...
},
{
  ...
  "body": " The Dedekind Cut  Dedekind, Richard Dedekind cuts definition of  Dedekind, Richard Dedekind cuts   A set of positive rational numbers is called a cut if   Comment  Take special notice that we are not using the negative rational numbers or zero to build our cuts. The reason for this will become clear shortly.      Property I  It contains a positive rational number but does not contain all positive rational numbers.    Property II  Every positive rational number in the set is less than every positive rational number not in the set.    Property III  There is no element of the set which is greater than every other element of the set.      "
},
{
