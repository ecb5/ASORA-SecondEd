...
},
{
  ...
  "number": "1.3.4",
  "title": "",
  "body": "  Fermat s Little Theorem problems leading to if a prime divides a product of two numbers then it divides one of the factors   Let be a prime number and positive integers such that . Show that or .    If then we are done. If not then notice that is a prime factor of . What does the Fundamental Theorem of Arithmetic say about the prime factors of compared to the prime factors of and    "
},
{
  ...
  "number": "1.3.5",
  "title": "",
  "body": "  Fermat s Little Theorem problems leading to if a prime divides an arbitrary product then it divides one of the factors   Let be a prime number and let be positive integers such that .  Use to show that for some .    Use induction on and the result of the previous problem.   "
},
{
  ...
  "number": "1.3.6",
  "title": "",
  "body": "  Fermat s Little Theorem problems leading to if is prime then divides   Let be a prime number and let be an integer with .  Use to prove that , where is the binomial coefficient .    We know , so . How does the previous result apply?   "
},
{
  ...
  "number": "1.3.7",
  "title": "",
  "body": "  Fermat s Little Theorem   Use to show that for all positive integers , thus proving Fermat s Little Theorem .    Use induction on . To get from to , use the binomial theorem on and the result of .   "
},
{
...
},
{
  ...
  "number": "3.1.5",
  "title": "",
  "body": " Problem differentiation rules   Assume is a positive integer.     Use Leibniz product rule to show that       Suppose , Use Leibniz product rule to show       Use the product rule and the result of part (b) to derive the quotient rule       Use the quotient rule to show that     "
},
{
  ...
  "number": "3.1.6",
  "title": "",
  "body": " Problem power rule with fractional exponents  differentiation power rule with fractional exponents   Suppose with , where and are integers. Show that .   "
},
{
...
},
{
  ...
  "number": "3.1.16",
  "title": "",
  "body": " Problem the Brachistochrone problem  Brachistochrone problem, the   Show that the equations satisfy equation equation . Bernoulli recognized this solution to be an inverted cycloid, the curve traced by a fixed point on a circle as the circle rolls along a horizontal surface.   "
},
{
...
},
{
  ...
  "number": "3.2.8",
  "title": "",
  "body": " Problem expand as a power series   Write as a power series expanded about and use your series to represent as a power series.   "
},
{
  ...
  "number": "3.2.9",
  "title": "",
  "body": " Problem power series expansion of   Let . Find a power series expansion about 0 for         "
},
{
  ...
  "number": "3.2.10",
  "title": "",
  "body": " Problem series solutions of  series solutions of   The ability to express complex functions as power series ( infinite polynomials ) became a tool of paramount importance for solving differential equations in the 1700s.     Show that if satisfies the differential equation , then and conclude that       Since also satisfies equation , we see that for some constants and . Show that in this case and and obtain     "
},
{
  ...
  "number": "3.2.11",
  "title": "",
  "body": " Problem differentiation of as a power series  derivative of the power series representation  differentiation of as a power series    Use the power series to obtain the power series       Let and and use a computer algebra system to plot these on the interval , for . Describe what is happening to the graph of the power series as becomes larger.    "
},
{
  ...
  "number": "3.2.12",
  "title": "",
  "body": " Problem power series expansion of   Use the power series for to compute as a power series.   "
},
{
...
},
{
  ...
  "number": "3.2.15",
  "title": "",
  "body": " Problem Alternating Geometric series   Use the Geometric series to find a power series representation for . Integrate this to obtain a power series representation for and compare your answer to part (b) of the previous problem. (This shows that there may be more than one way to obtain a power series representation.)   "
},
{
...
},
{
  ...
  "number": "3.2.17",
  "title": "",
  "body": " Problem Binomial series  Binomial Series, the squaring the   Consider the power series representation .  Multiply this power series by itself and compute the coefficients for in the resulting power series.   "
},
{
  ...
  "number": "3.2.18",
  "title": "",
  "body": " Problem power series expansion of  series graph the square root power series   Let .  Use a computer algebra system to plot for and compare these to the graph for . What seems to be happening? For what values of does the power series appear to converge to    "
},
{
  ...
  "number": "3.2.19",
  "title": "",
  "body": " Problem power series expansion  first series expansion   Use the power series to obtain the power series .  Use a computer algebra system to sum the first 100 terms of this power series and compare the answer to .   "
},
{
...
},
{
  ...
  "body": " The Basel Problem  Problem the Basel Problem  Euler, Leonhard Basel Problem, the   Recall that in we developed a power series representation of the function .     Show that the power series for is given by       Use part (a) to infer that the roots of are given by       Suppose is a polynomial with roots . Show that if  , then all the roots are non-zero and .      Assuming that the result in part (c) holds for an infinite polynomial (power series), deduce that       Expand this product to deduce that     "
},
{
  ...
  "body": " Euler s Formula  Problem Euler s Formula  Euler, Leonhard Euler s Formula    Use the power series expansion of , and to derive Euler s Formula :       Use Euler s formula to derive the Addition\/Subtraction formulas from Trigonometry:        Use Euler s formula to show that        Use Euler s formula to show that        Find a formula and for any positive integer .    "
},
{
...
},
{
  ...
  "number": "3.3.1",
  "title": "",
  "body": " Problem power series expansion of   Let .     Represent as a power series expanded about . That is, as a power series of the form .           Represent as a power series expanded about by integrating your solution to part (a).                   "
},
{
  ...
  "number": "3.3.2",
  "title": "",
  "body": " Problem power series expansion of  Let and use equation to represent as a power series expanded about .  "
},
{
  ...
  "number": "3.3.3",
  "title": "",
  "body": " Problem power series expansion of at  Let be a real number. Represent as power series expanded about . Notice there is no restriction on .  "
},
{
  ...
  "number": "3.3.4",
  "title": "",
  "body": " Problem power series expansion of  Let be a real number. Represent as a power series expanded about . What happens if ?  "
},
{
  ...
  "number": "3.3.5",
  "title": "",
  "body": " Problem power series expansion of   Let be a real number. Use the power series expansions to obtain the power series representation   This result will come into play in the next section.        "
},
{
...
},
{
  ...
  "number": "5.1.2",
  "title": "",
  "body": " Heat Equation, the  Heat Equation, the parameter must be less than zero   Show that satisfies the equation , where is an arbitrary constant. Use the physics of the problem to show that if is not constantly zero, then .    Consider .   "
},
{
  "id": "Interegnum-2-10",
  "level": "2",
...
},
{
  ...
  "number": "6.1.2",
  "title": "",
  "body": " Problem absolute value  absolute value   Let and be real numbers with . Prove if and only if .  Notice that this can be extended to if and only if .   "
},
{
  "id": "SeqRealNum-19",
  "level": "2",
...
},
{
  ...
  "number": "6.1.4",
  "title": "",
  "body": " Problem convergence to zero  convergence of a sequence convergence to zero drill   Use to prove the following.                 "
},
{
...
},
{
  ...
  "number": "6.1.6",
  "title": "",
  "body": " Problem convergence to zero  convergence of a sequence convergence to zero drill   Use to prove that    "
},
{
  "id": "prob_sequences3",
  "level": "2",
  ...
  "number": "6.1.7",
  "title": "",
  "body": " Problem if  limit if   Let be a nonzero real number with and let .     Solve the inequality for       Use part (a) to prove .      Where does your proof in part (b) break down if ?    "
},
{
...
},
{
  ...
  "number": "6.1.9",
  "title": "",
  "body": " Problem definition of non existence of a limit  limit definition of non existence    Negate to provide a formal definition for .         Use your definition from part (a) to prove .    "
},
{
...
},
{
  ...
  "number": "6.1.12",
  "title": "",
  "body": " Problem if  limit if   Let . Use to prove .    You will probably need to separate this into three cases: , , and .   "
},
{
  ...
  "number": "6.1.13",
  "title": "",
  "body": " Problem convergence\/divergence of the Geometric series  series Geometric series convergence\/divergence conditions for    Prove that if , then .      Use (a) to prove that if , then .    "
},
{
  "id": "SeqRealNum-49",
  "level": "2",
  ...
  "number": "6.1.14",
  "title": "",
  "body": " Problem definition of divergence  sequences definition of divergence  convergence definition of nonconvergence of a sequence    Provide a rigorous definition for .      Use your definition from part (a) to show that for any real number , .    Choose and use the fact that is equivalent to to show that no choice of will work for this .    "
},
{
  "id": "SeqRealNum-50",
  "level": "2",
  ...
  "number": "6.1.15",
  "title": "",
  "body": " Problem convergence of the absolute value of a sequence  convergence of a sequence implies the convergence of the absolute sequence   Prove that if then . Prove that the converse is true when , but it is not necessarily true otherwise.   "
},
{
  "id": "SeqRealNum-51",
  "level": "2",
  ...
  "number": "6.1.16",
  "title": "",
  "body": " Problem limit is unique  sequences limit is unique    Let and be sequences with . Suppose and . Prove .    Assume for contradiction, that and use the definition of convergence with to produce an with .      Prove that if a sequence converges, then its limit is unique. That is, prove that if and , then .    "
},
{
  "id": "SeqRealNum-52",
  "level": "2",
  ...
  "number": "6.1.17",
  "title": "",
  "body": " Problem the difference of sequences  sequences difference of  limit of the difference of sequences   Prove that if and , then .   "
},
{
  "id": "SeqRealNum-53",
  "level": "2",
  ...
  "number": "6.1.18",
  "title": "",
  "body": " Problem lower and upper bounds for sequences  sequences lower and upper bounds for    Prove that if and , then there exists a real number such that if then .      Prove that if and , then there exists a real number such that if then .    "
},
{
  "id": "prob_RatioTest",
  "level": "2",
  ...
  "body": " The Ratio Test  Problem Ratio Test  sequences Ratio Test for   Suppose is a sequence of positive numbers such that .     Prove that if , then .    Choose with . By the previous problem,  such that if , then . Let be fixed and show . Conclude that and let .      Let be a positive real number. Prove .    "
},
{
  "id": "LimitAsPrimary",
  "level": "1",
...
},
{
  ...
  "body": " Limit of a Constant Sequence is the Constant  Problem limit of a constant sequence  limit of a constant sequence  sequences constant sequences   Let be a constant sequence. Show that .   "
},
{
  "id": "Tri-RevTri-Ineq",
  "level": "2",
...
},
{
  ...
  "number": "6.2.3",
  "title": "",
  "body": " Triangle Inequalities Triangle Inequality  Problem The Triangle Inequality    Prove .    For the Reverse Triangle Inequality, consider .      Show .    You want to show that and that .    "
},
{
...
},
{
  ...
  "number": "6.2.5",
  "title": "",
  "body": " Problem termwise sums of sequences  sequences termwise sums of   Prove .                                           "
},
{
...
},
{
  ...
  "number": "6.2.8",
  "title": "",
  "body": " Problem convergent sequences are bounded  sequences convergence convergent sequences are bounded   Prove .    We know that there exists such that if , then . Let max , where represents the smallest integer greater than or equal to .          "
},
{
...
},
{
  ...
  "number": "6.2.9",
  "title": "",
  "body": " Problem termwise products of sequences  sequences termwise product of   Prove .   "
},
{
  "id": "cor_1",
  "level": "2",
...
},
{
  ...
  "number": "6.2.11",
  "title": "",
  "body": " Problem the limit of a constant times a sequence  sequences constant multiples of  limit of a constant times a sequence   Prove  .   "
},
{
...
},
{
  ...
  "number": "6.2.13",
  "title": "",
  "body": " Problem termwise quotient of sequence  sequences termwise quotient of   Prove .   SCRAPWORK   It is helpful to look first at the special case . The general case will follow from this and from .  Consider . We are faced with the same dilemma we had when we were proving ; we need to get bounded above. This means we need to get bounded away from zero (at least for large enough ).  This can be done as follows. Since , then . Thus, by the definition of there exists such that if , then . Thus when , and so . This says that for , . We should be able to make this smaller than a given , provided we make large enough.   "
},
{
  ...
  "number": "6.2.14",
  "title": "",
  "body": " Problem the limit of ratios of polynomials  limit identifing the theorems used in a limit  limit of ratios of polynomials    Use the theorems from this section to prove that .          Prove that , provided .  Be sure to explain why division by zero is not an issue. (See the hint.)    A polynomial only has finitely many roots.    "
},
{
...
},
{
  ...
  "number": "6.2.16",
  "title": "",
  "body": " Problem The Squeeze Theorem  limit Squeeze Theorem   Prove the Squeeze Theorem for Sequences .    This is probably a place where you would want to use instead of .   "
},
{
  "id": "example_SqzeEx",
  "level": "2",
...
},
{
  ...
  "number": "6.2.19",
  "title": "",
  "body": " Problem if the sequence is bounded then  sequences if the sequence is bounded then   Prove that if the sequence is bounded then .   "
},
{
  "id": "DivergentSeq",
  "level": "1",
...
},
{
  ...
  "number": "6.3.3",
  "title": "",
  "body": " Problem Prove that diverges  Prove that diverges using .  "
},
{
  "id": "def_DivToInf",
  "level": "2",
...
},
{
  ...
  "number": "6.3.6",
  "title": "",
  "body": " Problem Prove that divergence to infinity implies divergence.  Prove .  "
},
{
  "id": "DivergentSeq-24",
  "level": "2",
  ...
  "number": "6.3.7",
  "title": "",
  "body": " Problem the sequence of positive integers diverges to infinity  sequences the sequence of positive integers diverges to infinity    Show that diverges to infinity.      Show that diverges to infinity.    "
},
{
  "id": "DivergentSeq-28",
  "level": "2",
  ...
  "number": "6.3.8",
  "title": "",
  "body": " Problem termwise sums of sequences  sequences termwise sums of   Suppose and .     Show that       Show that       Is it true that Explain.    "
},
{
  "id": "DivergentSeq-30",
  "level": "2",
  ...
  "number": "6.3.9",
  "title": "",
  "body": " Problem divergence to  sequences divergence to   Suppose and and . Prove or give a counterexample:                               "
},
{
  "id": "DivergentSeq-32",
  "level": "2",
  ...
  "number": "6.3.10",
  "title": "",
  "body": " Problem divergence, but not to infinity  sequences divergence of  sequences divergence, but not to infinity   Show that each of the following sequences diverges.                        "
},
{
  "id": "DivergentSeq-33",
  "level": "2",
  ...
  "number": "6.3.11",
  "title": "",
  "body": " Problem divergence, but not to infinity  sequences divergence, but not to infinity   Suppose that diverges but not to infinity and that is a real number. What conditions on will guarantee that:      converges?       diverges?    "
},
{
  "id": "DivergentSeq-34",
  "level": "2",
  ...
  "number": "6.3.12",
  "title": "",
  "body": " Problem Geometric Sequence  series Geometric Sequence divergence condition  sequences Geometric   Show that if then diverges. Will it diverge to infinity?   "
},
{
...
},
{
  ...
  "number": "8.1.5",
  "title": "",
  "body": " Problem continuous non differentiable function  Weierstrass, Karl continuous, everywhere non differentiable function  continuity Weierstrass continuous, but non differentiable function    Given , what is the smallest value of for which satisfies Weierstrass criterion to be continuous and nowhere differentiable.      Let and use a computer algebra system to plot for and .      Plot for , where . Based upon what you see in parts b and c, why would we describe the function to be somewhat fractal in nature?    "
},
{
...
},
{
  ...
  "number": "8.1.9",
  "title": "",
  "body": " Problem is continuous everywhere  continuity is continuous everywhere   Use the definition of continuity to show that if and are fixed (but unspecified) real numbers then the function is continuous at every real number .   "
},
{
...
},
{
  ...
  "number": "8.1.12",
  "title": "",
  "body": " Problem continuity    continuity is continuous at zero Use the definition of continuity to show that is continuous at .   "
},
{
  ...
  "number": "8.1.13",
  "title": "",
  "body": " Problem is continuous at zero  is continuous at zero   Use the definition of continuity to show that is continuous at . How is this problem different from ? How is it similar?   "
},
{
...
},
{
  ...
  "number": "8.1.16",
  "title": "",
  "body": " Problem is continuous at every positive real number  is continuous at every positive real number   Use the definition of continuity to show that is continuous at any positive real number .   "
},
{
  ...
  "number": "8.1.17",
  "title": "",
  "body": " Problem is continuous for  is continuous for    Use a unit circle to show that for , and and conclude and for  .      Use the definition of continuity to prove that is continuous at any point .     .    "
},
{
  ...
  "number": "8.1.18",
  "title": "",
  "body": " Problem is continuous everywhere  continuity is continuous everywhere  continuous functions is continuous everywhere    Use the definition of continuity to show that is continuous at .      Show that is continuous at any point .    Rewrite as and use what you proved in part a.    "
},
{
  ...
  "number": "8.1.19",
  "title": "",
  "body": " Problem constant functions are continuous  continuous functions a constant function is continuous  continuity of a constant function   Use the definition of continuity to prove that the constant function is continuous at any point .   "
},
{
  ...
  "number": "8.1.20",
  "title": "",
  "body": " Problem is continuous everywhere  continuous functions is continuous everywhere  continuity of    Use the definition of continuity to prove that is continuous at .    You may want to use the fact to find a .      Use part (a) to prove that is continuous at any positive real number .     . This is a combination of functions which are continuous at . Be sure to explain how you know that is continuous at .    "
},
{
  ...
  "number": "8.1.21",
  "title": "",
  "body": " Problem the Topologist s sine function is continuous at zero  Topologist s sine function is continuous at zero   Use the definition of continuity to show that is continuous at .   "
},
{
...
},
{
  ...
  "number": "8.1.23",
  "title": "",
  "body": " Problem definition of continuitycon  continuity formal definition of discontinuity   Write a formal definition of the statement is not continuous at , and use it to prove that the function is not continuous at .   "
},
{
...
},
{
  ...
  "number": "8.2.3",
  "title": "",
  "body": " Problem Heaviside s function is not continuous at zero  continuity Heaviside s function is not continuous at zero   Use to show that is not continuous at , no matter what value is.   "
},
{
  ...
  "number": "8.2.4",
  "title": "",
  "body": " Problem continuity   continuity  of using sequences    Let .     Use to show that is continuous at .      Use to show that is not continuous if .    "
},
{
  ...
  "body": " The Topologist s Sine Curve  Problem Topologist s sine function modified version is not continuous at zero  Topologist s sine function modified version is not continuous at zero   The function is often called the topologist s sine curve. Whereas has roots at , and oscillates infinitely often as , has roots at , and oscillates infinitely often as approaches zero. A rendition of the graph follows.     Notice that is not even defined at . We can extend to be defined at by simply choosing a value at . Since this will be a new function we give it a new name. .  Use to show that is not continuous at , no matter what value is chosen for .   "
},
{
...
},
{
  ...
  "number": "8.2.6",
  "title": "",
  "body": " Problem continuity via sequences    continuity via sequences  limit and sequences Turn the ideas of the previous two paragraphs into a formal proof of .   "
},
{
  "id": "thm_ContSumProd",
  "level": "2",
...
},
{
  ...
  "number": "8.2.8",
  "title": "",
  "body": " Problem the product of continuous functions is continuous  continuous functions the product of continuous functions is continuous  continuity of a product   Use to show that if and are continuous at , then is continuous at .   "
},
{
...
},
{
  ...
  "number": "8.2.10",
  "title": "",
  "body": " Problem if is continuouse and then is bounded away from zero near a  continuous functions if is continuouse and then is bounded away from zero near a  continuity of a quotient   Prove .    Consider the case where . Use the definition with . The picture is below; make it formal.     For the case , consider the function .   "
},
{
  ...
  "number": "8.2.11",
  "title": "",
  "body": " Problem the quotient of continuous functions is continuous  continuous functions the quotient of continuous functions is continuous   Use , to prove that if and are continuous at and , then is continuous at .   "
},
{
  "id": "thm_ContComp",
  "level": "2",
...
},
{
  ...
  "number": "8.2.13",
  "title": "",
  "body": " Problem the composition of continuous functions is continuous  continuous functions the composition of continuous functions is continuous  continuity of a composition   Prove      Using the definition of continuity .      Using .    "
},
{
  ...
  "number": "8.2.14",
  "title": "",
  "body": " Problem is continuous everywhere  continuity is continuous everywhere   What allows us to conclude that is continuous at any point without referring back to the definition of continuity?   "
},
{
  ...
  "number": "8.2.15",
  "title": "",
  "body": " Problem continuous functions  continuity drill problems   Show that each of the following is a continuous function at every point in its domain.     Any polynomial.      Any rational function. (A rational function is defined to be a ratio of polynomials.)       .      The other trig functions: , , , and .    "
},
{
...
},
{
  ...
  "number": "8.2.16",
  "title": "",
  "body": " Problem continuity  continuity   Compute the following limits. Be sure to explain how continuity is involved.                        "
},
{
...
},
{
  ...
  "number": "9.1.9",
  "title": "",
  "body": " Euler, Leonhard Euler ns constant slow convergence to    Use the inequality for all to approximate to three decimal places.      Use the fact that for large , to determine approximately how large must be to make .      Suppose we have a supercomputer which can add trillion terms of the Harmonic Series per second. Approximately how many times the current age of the Earth would it take for this computer to sum the Harmonic Series until it surpasses ?    "
},
{
...
},
{
  ...
  "number": "10.1.7",
  "title": "",
  "body": " limit verifying limits via continuity   Use to verify each of the following limits.           .                "
},
{
...
},
{
  ...
  "number": "10.1.12",
  "title": "",
  "body": " limit properties of  limit verify limit laws from Calculus   Use to prove parts (b) and (c) of .   "
},
{
...
},
{
  ...
  "number": "10.1.14",
  "title": "",
  "body": " Squeeze Theorem for functions   Prove the Squeeze Theorem for functions .    Use the Squeeze Theorem for Sequences .   "
},
{
...
},
{
  ...
  "number": "10.1.16",
  "title": "",
  "body": " limit   Returning to we see that the Squeeze Theorem is just what we need. First notice that since is an even function, we only need to focus on in our inequalities. Consider the unit circle seen in .     Show that       Use the result in part (a) to show that if , then .      Use the fact that and are both even functions to show that equation is also true for       Use equation and the Squeeze Theorem for Functions to show .    "
},
{
...
},
{
  ...
  "number": "10.4.10",
  "title": "",
  "body": " Dirichlet s Function   In honor of Dirichlet his function is often denoted . It is defined as follows: .  Show that is not Riemann integrable on .    Use Darboux s definition of the Riemann integral.   "
},
{
...
},
{
  ...
  "number": "11.2.29",
  "title": "",
  "body": " series absolute convergence of vs. the absolute value of a series   If , does it follow that ? Justify your answer. What can be said?   "
},
{
...
},
{
  ...
  "number": "11.3.8",
  "title": "",
  "body": " Weierstrass- Test  Weierstrass- Test drill problems     Identify which of the following series converges pointwise and which converges uniformly on the interval . In every case identify the limit function.                        "
},
{
...
},
{
  ...
  "number": "11.3.13",
  "title": "",
  "body": " power series term by term derivative of   Prove .    Let be a number with and consider . Now use the Comparison Test and .   "
},
{
...
},
{
  ...
  "number": "11.4.6",
  "title": "",
  "body": " Abel, Niels Henrik Abel s Lemma   Prove Abel s Lemma .   "
},
{
  ...
  "number": "11.4.7",
  "title": "",
  "body": " Abel, Niels Henrik Abel s Theorem   Prove Abel s Theorem .    Let . Since converges then by the Cauchy Criterion, there exists such that if then . Let . By Abel s Lemma , .  Thus for , ,    "
},
{
...
},
{
  ...
  "number": "12.1.1",
  "title": "",
  "body": " Problem a closed interval is a closed set   Prove that a closed interval, is also a closed set.       First suppose that . There are two cases:   Case 1       Case 2   .      "
},
{
  ...
  "number": "12.1.2",
  "title": "",
  "body": " Problem a closed set is not (necessarily) a closed inteval  The converse of is not true. That is, not every closed set is also a closed interval. Convince yourself that each of the sets below is closed.    ,     ,     ,     ,    any finite set,              the union of two closed sets     "
},
{
...
},
{
  ...
  "number": "12.1.4",
  "title": "",
  "body": " Problem open sets   Show that a set is open if and only if for all there is an such that     Notice that if is closed then is not a limit point of . What does tell you?   "
},
{
  ...
  "number": "12.1.5",
  "title": "",
  "body": " Problem open intervals are not the only open sets  Open intervals are not the only open sets. Convince yourself that each of the following are also open sets.         where each is an open set.    "
},
{
  ...
  "number": "12.1.6",
  "title": "",
  "body": " Problem sets that are neither open nor closed  Of course, there are sets which are neither open nor closed.  Convince yourself that these sets are neither open nor closed.   ,   ,       "
},
{
...
},
{
  ...
  "number": "12.1.8",
  "title": "",
  "body": " Problem continuity via set theory  Show that a function is continuous at if and only if for every open set containing there is an open set containing with .       "
},
{
...
},
{
  ...
  "number": "12.2.2",
  "title": "",
  "body": " Problem Nested Interval Property weak form  Nested Interval Property weak form   Suppose . Show that there are at least two points, and , such that and for all .   "
},
{
...
},
{
  ...
  "number": "12.2.6",
  "title": "",
  "body": " Problem countable sets  countable sets countable sets drill, 5 parts   Most of the sets you have encountered so far in your life have been countable. Show that each of the following sets is countable.                          The set of prime numbers           "
},
{
  ...
  "number": "12.2.7",
  "title": "",
  "body": " Problem countable sets unions and intersections of  countable sets unions and intersections of   If we start with one or more countable sets it is rather difficult to use it to build anything but another countable set.  Let be a collection of countable sets. Show that each of the following sets is also countable:     Any subset of .                                "
},
{
  "id": "thm_QisCountable",
  "level": "2",
...
},
{
  ...
  "number": "12.2.9",
  "title": "",
  "body": " Problem is countable  is countable   Prove .   "
},
{
  ...
  "number": "12.2.10",
  "title": "",
  "body": " Problem intervals are uncountable  sets intervals are uncountable    Let and be two open intervals of real numbers. Show that these two sets have the same cardinality by constructing a one to one onto function between them.    A linear function should do the trick.      Show that any open interval of real numbers has the same cardinality as .    Consider the interval .      Show that and have the same cardinality.    If let correspond to itself. Note that and are both countable.         Show that and have the same cardinality.    "
},
{
...
},
{
  ...
  "number": "12.3.4",
  "title": "",
  "body": " Problem open covers   Construct two distinct open covers of each of the following sets. (There is more than one correct answer.)     The empty set: .                                       "
},
{
...
},
{
  ...
  "number": "12.3.6",
  "title": "",
  "body": " Problem outer measure   Compute the outer measure of each of the following sets.      where .       .                              "
},
{
...
},
{
  ...
  "number": "12.3.11",
  "title": "",
  "body": " Problem measure zero    Observe that does not say that anything is equal to zero. Explain how we can still conclude that the set has measure zero .      Prove .    Consider the interval .]    "
},
{
...
},
{
  ...
  "body": " The Lebesgue Integral of Dirichlet s Function  Problem Dirichlet s Function Lebesgue integral of  Dirichlet s Function Lebesgue integral of  Use and equation to show that .  "
},
{
...
},
{
  ...
  "number": "12.4.2",
  "title": "",
  "body": " Problem Geometric series  series Geometric series  converges to   Consider the sequence . Determine that this sequence converges and, in fact, it converges to . This suggests that .   "
},
{
...
},
{
  ...
  "number": "12.4.4",
  "title": "",
  "body": " Problem power set  sets power set  sets cardinality of a power set  cardinality of a power set   Prove: If , then .    Let . Consider the following correspondence between the elements of and the set of all -tuples of yes (Y) or no (N):   How many elements are in    "
},
{
  ...
  "number": "12.4.5",
  "title": "",
  "body": " Problem Cantor s Theorem  Cantor, Georg Cantor s Theorem   Remarkably, Cantor s Theorem holds for infinite sets as well.  Prove Cantor s Theorem .    Assume for contradiction, that there is a one to one correspondence . Consider . Since is onto, then there is such that . Is or is    "
},
{
  ...
  "number": "12.4.6",
  "title": "",
  "body": " Problem countable union of finite sets    countable sets countable union of finite sets Let . Show that for each , is finite and use this to conclude that is countably infinite.   "
},
{
  ...
  "number": "12.4.7",
  "title": "",
  "body": " Problem countably infinite subsets    sets countably infinite subsets Let be an infinite set. Prove that contains a countably infinite subset.   "
},
{
  ...
  "number": "12.4.8",
  "title": "",
  "body": " Problem deleting a countable subset from an uncountable set  uncountable sets deleting a countable subset   Suppose is an uncountable set and is countably infinite.        Prove that and have the same cardinality.    Let . Since is an infinite set, then by the previous problem it contains a countably infinite set . Likewise since is infinite it also contains a countably infinite set . Again, since is a countably infinite set then it contains a countably infinite set , etc. For , let be a one to one correspondence and define by .  Show that is one to one and onto.   "
},
{
