...
},
{
  ...
  "number": "12.2.3",
  "title": "Cantor, (1874).",
  "body": " Cantor, (1874)   Cantor, Georg  first proof that is uncountable     is uncountable  Cantor s first proof    Let be a sequence of real numbers. There is a real number , which is not in .   Abuse of Notation  To streamline things, we are abusing notation here as we are letting denote both the sequence (which is ordered) and the underlying (unordered) set of entries in the sequence.    "
},
{
